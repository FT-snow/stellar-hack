...
export default function ThemeExplorerSection() {
  ...
  return (
    <section className="relative py-32 md:py-48 px-6 md:px-12 max-w-7xl mx-auto mt-24 md:mt-32">
      <ScrollReveal>
        ...
        {THEMES.map((t, i) => {
          ...
          return (
            <div key={t.id}>
              ...
              >
                <h3
                  className="text-base md:text-lg font-bold transition-colors duration-300 group-hover:text-[rgba(94,234,212,0.8)]"
      ...
      <ScrollReveal delay={0.3}>
        <p
          ...
          style={{ color: 'var(--text-muted)' }}
        >
          We give you the universe. You choose the crisis. Build the dashboard around it.
        </p>
      </ScrollReveal>
    </section>
  )

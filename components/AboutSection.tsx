    ...
    >
      <div className="w-full max-w-7xl mx-auto">
        ...
        >
          ...
          >
            A 2-day vibe-athon by COSMOS — the Science Club of MUJ. Teams
            imagine a fictional universe, define a mission inside it, then build
            a frontend-only interactive dashboard that solves it. No backend.
            Pure creativity, design, and code.
          </motion.p>
